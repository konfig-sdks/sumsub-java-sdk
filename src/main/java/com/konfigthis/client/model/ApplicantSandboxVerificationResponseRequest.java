...
public class ApplicantSandboxVerificationResponseRequest {
  ...
  public ApplicantSandboxVerificationResponseRequest() {
  }

  public ApplicantSandboxVerificationResponseRequest reviewAnswer(String reviewAnswer) {
  ...
  **/
  ...
  public ApplicantSandboxVerificationResponseRequest rejectLabels(List<String> rejectLabels) {
  ...
  public ApplicantSandboxVerificationResponseRequest addRejectLabelsItem(String rejectLabelsItem) {
  ...
  **/
  ...
  public ApplicantSandboxVerificationResponseRequest reviewRejectType(String reviewRejectType) {
  ...
  **/
  ...
  public ApplicantSandboxVerificationResponseRequest clientComment(String clientComment) {
  ...
  **/
  ...
  public ApplicantSandboxVerificationResponseRequest moderationComment(String moderationComment) {
  ...
  **/
   ...
   * @return the ApplicantSandboxVerificationResponseRequest instance itself
   */
  public ApplicantSandboxVerificationResponseRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicantSandboxVerificationResponseRequest applicantSandboxVerificationResponseRequest = (ApplicantSandboxVerificationResponseRequest) o;
    return Objects.equals(this.reviewAnswer, applicantSandboxVerificationResponseRequest.reviewAnswer) &&
        Objects.equals(this.rejectLabels, applicantSandboxVerificationResponseRequest.rejectLabels) &&
        Objects.equals(this.reviewRejectType, applicantSandboxVerificationResponseRequest.reviewRejectType) &&
        Objects.equals(this.clientComment, applicantSandboxVerificationResponseRequest.clientComment) &&
        Objects.equals(this.moderationComment, applicantSandboxVerificationResponseRequest.moderationComment)&&
        Objects.equals(this.additionalProperties, applicantSandboxVerificationResponseRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicantSandboxVerificationResponseRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplicantSandboxVerificationResponseRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicantSandboxVerificationResponseRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicantSandboxVerificationResponseRequest is not found in the empty JSON string", ApplicantSandboxVerificationResponseRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicantSandboxVerificationResponseRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicantSandboxVerificationResponseRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicantSandboxVerificationResponseRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicantSandboxVerificationResponseRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicantSandboxVerificationResponseRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicantSandboxVerificationResponseRequest>() {
           @Override
           public void write(JsonWriter out, ApplicantSandboxVerificationResponseRequest value) throws IOException {
           ...
           @Override
           public ApplicantSandboxVerificationResponseRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApplicantSandboxVerificationResponseRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApplicantSandboxVerificationResponseRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApplicantSandboxVerificationResponseRequest
  * @throws IOException if the JSON string is invalid with respect to ApplicantSandboxVerificationResponseRequest
  */
  public static ApplicantSandboxVerificationResponseRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicantSandboxVerificationResponseRequest.class);
  }

 /**
  * Convert an instance of ApplicantSandboxVerificationResponseRequest to an JSON string
  *
  * @return JSON string
  */
