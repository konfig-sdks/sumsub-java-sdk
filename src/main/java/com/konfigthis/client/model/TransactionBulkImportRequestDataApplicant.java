...
public class TransactionBulkImportRequestDataApplicant {
  ...
  public TransactionBulkImportRequestDataApplicant() {
  }

  public TransactionBulkImportRequestDataApplicant externalUserId(String externalUserId) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataApplicant fullName(String fullName) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataApplicant type(String type) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataApplicant address(ApplicantSubmitTransactionDataRequestApplicantAddress address) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataApplicant institutionInfo(ApplicantSubmitTransactionDataRequestApplicantInstitutionInfo institutionInfo) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataApplicant paymentMethod(ApplicantSubmitTransactionDataRequestApplicantPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataApplicant device(ApplicantSubmitTransactionDataRequestApplicantDevice device) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataApplicant idDocs(List<ApplicantSubmitTransactionDataRequestApplicantIdDocsInner> idDocs) {
  ...
  public TransactionBulkImportRequestDataApplicant addIdDocsItem(ApplicantSubmitTransactionDataRequestApplicantIdDocsInner idDocsItem) {
    if (this.idDocs == null) {
  ...
  **/
   ...
   * @return the TransactionBulkImportRequestDataApplicant instance itself
   */
  public TransactionBulkImportRequestDataApplicant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionBulkImportRequestDataApplicant transactionBulkImportRequestDataApplicant = (TransactionBulkImportRequestDataApplicant) o;
    return Objects.equals(this.externalUserId, transactionBulkImportRequestDataApplicant.externalUserId) &&
        Objects.equals(this.fullName, transactionBulkImportRequestDataApplicant.fullName) &&
        Objects.equals(this.type, transactionBulkImportRequestDataApplicant.type) &&
        Objects.equals(this.address, transactionBulkImportRequestDataApplicant.address) &&
        Objects.equals(this.institutionInfo, transactionBulkImportRequestDataApplicant.institutionInfo) &&
        Objects.equals(this.paymentMethod, transactionBulkImportRequestDataApplicant.paymentMethod) &&
        Objects.equals(this.device, transactionBulkImportRequestDataApplicant.device) &&
        Objects.equals(this.idDocs, transactionBulkImportRequestDataApplicant.idDocs)&&
        Objects.equals(this.additionalProperties, transactionBulkImportRequestDataApplicant.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionBulkImportRequestDataApplicant {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionBulkImportRequestDataApplicant
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionBulkImportRequestDataApplicant.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionBulkImportRequestDataApplicant is not found in the empty JSON string", TransactionBulkImportRequestDataApplicant.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionBulkImportRequestDataApplicant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionBulkImportRequestDataApplicant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionBulkImportRequestDataApplicant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionBulkImportRequestDataApplicant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionBulkImportRequestDataApplicant.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionBulkImportRequestDataApplicant>() {
           @Override
           public void write(JsonWriter out, TransactionBulkImportRequestDataApplicant value) throws IOException {
           ...
           @Override
           public TransactionBulkImportRequestDataApplicant read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TransactionBulkImportRequestDataApplicant instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionBulkImportRequestDataApplicant given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionBulkImportRequestDataApplicant
  * @throws IOException if the JSON string is invalid with respect to TransactionBulkImportRequestDataApplicant
  */
  public static TransactionBulkImportRequestDataApplicant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionBulkImportRequestDataApplicant.class);
  }

 /**
  * Convert an instance of TransactionBulkImportRequestDataApplicant to an JSON string
  *
  * @return JSON string
  */
