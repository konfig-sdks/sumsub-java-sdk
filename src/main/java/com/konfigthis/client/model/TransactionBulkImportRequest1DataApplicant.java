...
public class TransactionBulkImportRequest1DataApplicant {
  ...
  public TransactionBulkImportRequest1DataApplicant() {
  }

  public TransactionBulkImportRequest1DataApplicant externalUserId(String externalUserId) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataApplicant fullName(String fullName) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataApplicant type(String type) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataApplicant address(ApplicantSubmitTransactionDataRequestApplicantAddress address) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataApplicant institutionInfo(ApplicantSubmitTransactionDataRequestApplicantInstitutionInfo institutionInfo) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataApplicant paymentMethod(ApplicantSubmitTransactionDataRequestApplicantPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataApplicant device(ApplicantSubmitTransactionDataRequestApplicantDevice device) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataApplicant idDocs(List<ApplicantSubmitTransactionDataRequestApplicantIdDocsInner> idDocs) {
  ...
  public TransactionBulkImportRequest1DataApplicant addIdDocsItem(ApplicantSubmitTransactionDataRequestApplicantIdDocsInner idDocsItem) {
    if (this.idDocs == null) {
  ...
  **/
   ...
   * @return the TransactionBulkImportRequest1DataApplicant instance itself
   */
  public TransactionBulkImportRequest1DataApplicant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionBulkImportRequest1DataApplicant transactionBulkImportRequest1DataApplicant = (TransactionBulkImportRequest1DataApplicant) o;
    return Objects.equals(this.externalUserId, transactionBulkImportRequest1DataApplicant.externalUserId) &&
        Objects.equals(this.fullName, transactionBulkImportRequest1DataApplicant.fullName) &&
        Objects.equals(this.type, transactionBulkImportRequest1DataApplicant.type) &&
        Objects.equals(this.address, transactionBulkImportRequest1DataApplicant.address) &&
        Objects.equals(this.institutionInfo, transactionBulkImportRequest1DataApplicant.institutionInfo) &&
        Objects.equals(this.paymentMethod, transactionBulkImportRequest1DataApplicant.paymentMethod) &&
        Objects.equals(this.device, transactionBulkImportRequest1DataApplicant.device) &&
        Objects.equals(this.idDocs, transactionBulkImportRequest1DataApplicant.idDocs)&&
        Objects.equals(this.additionalProperties, transactionBulkImportRequest1DataApplicant.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionBulkImportRequest1DataApplicant {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionBulkImportRequest1DataApplicant
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionBulkImportRequest1DataApplicant.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionBulkImportRequest1DataApplicant is not found in the empty JSON string", TransactionBulkImportRequest1DataApplicant.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionBulkImportRequest1DataApplicant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionBulkImportRequest1DataApplicant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionBulkImportRequest1DataApplicant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionBulkImportRequest1DataApplicant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionBulkImportRequest1DataApplicant.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionBulkImportRequest1DataApplicant>() {
           @Override
           public void write(JsonWriter out, TransactionBulkImportRequest1DataApplicant value) throws IOException {
           ...
           @Override
           public TransactionBulkImportRequest1DataApplicant read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TransactionBulkImportRequest1DataApplicant instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionBulkImportRequest1DataApplicant given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionBulkImportRequest1DataApplicant
  * @throws IOException if the JSON string is invalid with respect to TransactionBulkImportRequest1DataApplicant
  */
  public static TransactionBulkImportRequest1DataApplicant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionBulkImportRequest1DataApplicant.class);
  }

 /**
  * Convert an instance of TransactionBulkImportRequest1DataApplicant to an JSON string
  *
  * @return JSON string
  */
