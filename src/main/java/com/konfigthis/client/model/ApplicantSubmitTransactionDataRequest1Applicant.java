...
public class ApplicantSubmitTransactionDataRequest1Applicant {
  ...
  public ApplicantSubmitTransactionDataRequest1Applicant() {
  }

  public ApplicantSubmitTransactionDataRequest1Applicant externalUserId(String externalUserId) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Applicant fullName(String fullName) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Applicant type(String type) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Applicant address(ApplicantSubmitTransactionDataRequestApplicantAddress address) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Applicant institutionInfo(ApplicantSubmitTransactionDataRequestApplicantInstitutionInfo institutionInfo) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Applicant paymentMethod(ApplicantSubmitTransactionDataRequestApplicantPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Applicant device(ApplicantSubmitTransactionDataRequestApplicantDevice device) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Applicant idDocs(List<ApplicantSubmitTransactionDataRequestApplicantIdDocsInner> idDocs) {
  ...
  public ApplicantSubmitTransactionDataRequest1Applicant addIdDocsItem(ApplicantSubmitTransactionDataRequestApplicantIdDocsInner idDocsItem) {
    if (this.idDocs == null) {
  ...
  **/
   ...
   * @return the ApplicantSubmitTransactionDataRequest1Applicant instance itself
   */
  public ApplicantSubmitTransactionDataRequest1Applicant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicantSubmitTransactionDataRequest1Applicant applicantSubmitTransactionDataRequest1Applicant = (ApplicantSubmitTransactionDataRequest1Applicant) o;
    return Objects.equals(this.externalUserId, applicantSubmitTransactionDataRequest1Applicant.externalUserId) &&
        Objects.equals(this.fullName, applicantSubmitTransactionDataRequest1Applicant.fullName) &&
        Objects.equals(this.type, applicantSubmitTransactionDataRequest1Applicant.type) &&
        Objects.equals(this.address, applicantSubmitTransactionDataRequest1Applicant.address) &&
        Objects.equals(this.institutionInfo, applicantSubmitTransactionDataRequest1Applicant.institutionInfo) &&
        Objects.equals(this.paymentMethod, applicantSubmitTransactionDataRequest1Applicant.paymentMethod) &&
        Objects.equals(this.device, applicantSubmitTransactionDataRequest1Applicant.device) &&
        Objects.equals(this.idDocs, applicantSubmitTransactionDataRequest1Applicant.idDocs)&&
        Objects.equals(this.additionalProperties, applicantSubmitTransactionDataRequest1Applicant.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicantSubmitTransactionDataRequest1Applicant {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplicantSubmitTransactionDataRequest1Applicant
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicantSubmitTransactionDataRequest1Applicant.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicantSubmitTransactionDataRequest1Applicant is not found in the empty JSON string", ApplicantSubmitTransactionDataRequest1Applicant.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicantSubmitTransactionDataRequest1Applicant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicantSubmitTransactionDataRequest1Applicant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicantSubmitTransactionDataRequest1Applicant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicantSubmitTransactionDataRequest1Applicant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicantSubmitTransactionDataRequest1Applicant.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicantSubmitTransactionDataRequest1Applicant>() {
           @Override
           public void write(JsonWriter out, ApplicantSubmitTransactionDataRequest1Applicant value) throws IOException {
           ...
           @Override
           public ApplicantSubmitTransactionDataRequest1Applicant read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApplicantSubmitTransactionDataRequest1Applicant instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApplicantSubmitTransactionDataRequest1Applicant given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApplicantSubmitTransactionDataRequest1Applicant
  * @throws IOException if the JSON string is invalid with respect to ApplicantSubmitTransactionDataRequest1Applicant
  */
  public static ApplicantSubmitTransactionDataRequest1Applicant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicantSubmitTransactionDataRequest1Applicant.class);
  }

 /**
  * Convert an instance of ApplicantSubmitTransactionDataRequest1Applicant to an JSON string
  *
  * @return JSON string
  */
