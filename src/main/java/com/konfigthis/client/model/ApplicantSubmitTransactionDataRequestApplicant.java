...
public class ApplicantSubmitTransactionDataRequestApplicant {
  ...
  public ApplicantSubmitTransactionDataRequestApplicant() {
  }

  public ApplicantSubmitTransactionDataRequestApplicant externalUserId(String externalUserId) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequestApplicant fullName(String fullName) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequestApplicant type(String type) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequestApplicant address(ApplicantSubmitTransactionDataRequestApplicantAddress address) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequestApplicant institutionInfo(ApplicantSubmitTransactionDataRequestApplicantInstitutionInfo institutionInfo) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequestApplicant paymentMethod(ApplicantSubmitTransactionDataRequestApplicantPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequestApplicant device(ApplicantSubmitTransactionDataRequestApplicantDevice device) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequestApplicant idDocs(List<ApplicantSubmitTransactionDataRequestApplicantIdDocsInner> idDocs) {
  ...
  public ApplicantSubmitTransactionDataRequestApplicant addIdDocsItem(ApplicantSubmitTransactionDataRequestApplicantIdDocsInner idDocsItem) {
    if (this.idDocs == null) {
  ...
  **/
   ...
   * @return the ApplicantSubmitTransactionDataRequestApplicant instance itself
   */
  public ApplicantSubmitTransactionDataRequestApplicant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicantSubmitTransactionDataRequestApplicant applicantSubmitTransactionDataRequestApplicant = (ApplicantSubmitTransactionDataRequestApplicant) o;
    return Objects.equals(this.externalUserId, applicantSubmitTransactionDataRequestApplicant.externalUserId) &&
        Objects.equals(this.fullName, applicantSubmitTransactionDataRequestApplicant.fullName) &&
        Objects.equals(this.type, applicantSubmitTransactionDataRequestApplicant.type) &&
        Objects.equals(this.address, applicantSubmitTransactionDataRequestApplicant.address) &&
        Objects.equals(this.institutionInfo, applicantSubmitTransactionDataRequestApplicant.institutionInfo) &&
        Objects.equals(this.paymentMethod, applicantSubmitTransactionDataRequestApplicant.paymentMethod) &&
        Objects.equals(this.device, applicantSubmitTransactionDataRequestApplicant.device) &&
        Objects.equals(this.idDocs, applicantSubmitTransactionDataRequestApplicant.idDocs)&&
        Objects.equals(this.additionalProperties, applicantSubmitTransactionDataRequestApplicant.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicantSubmitTransactionDataRequestApplicant {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplicantSubmitTransactionDataRequestApplicant
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicantSubmitTransactionDataRequestApplicant.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicantSubmitTransactionDataRequestApplicant is not found in the empty JSON string", ApplicantSubmitTransactionDataRequestApplicant.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicantSubmitTransactionDataRequestApplicant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicantSubmitTransactionDataRequestApplicant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicantSubmitTransactionDataRequestApplicant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicantSubmitTransactionDataRequestApplicant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicantSubmitTransactionDataRequestApplicant.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicantSubmitTransactionDataRequestApplicant>() {
           @Override
           public void write(JsonWriter out, ApplicantSubmitTransactionDataRequestApplicant value) throws IOException {
           ...
           @Override
           public ApplicantSubmitTransactionDataRequestApplicant read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApplicantSubmitTransactionDataRequestApplicant instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApplicantSubmitTransactionDataRequestApplicant given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApplicantSubmitTransactionDataRequestApplicant
  * @throws IOException if the JSON string is invalid with respect to ApplicantSubmitTransactionDataRequestApplicant
  */
  public static ApplicantSubmitTransactionDataRequestApplicant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicantSubmitTransactionDataRequestApplicant.class);
  }

 /**
  * Convert an instance of ApplicantSubmitTransactionDataRequestApplicant to an JSON string
  *
  * @return JSON string
  */
