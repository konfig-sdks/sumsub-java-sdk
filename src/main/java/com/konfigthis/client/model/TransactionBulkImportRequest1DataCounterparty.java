...
public class TransactionBulkImportRequest1DataCounterparty {
  ...
  public TransactionBulkImportRequest1DataCounterparty() {
  }

  public TransactionBulkImportRequest1DataCounterparty externalUserId(String externalUserId) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataCounterparty fullName(String fullName) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataCounterparty type(String type) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataCounterparty address(ApplicantSubmitTransactionDataRequestApplicantAddress address) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataCounterparty institutionInfo(ApplicantSubmitTransactionDataRequestApplicantInstitutionInfo institutionInfo) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataCounterparty paymentMethod(ApplicantSubmitTransactionDataRequestApplicantPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataCounterparty device(ApplicantSubmitTransactionDataRequestApplicantDevice device) {
  ...
  **/
  ...
  public TransactionBulkImportRequest1DataCounterparty idDocs(List<ApplicantSubmitTransactionDataRequestApplicantIdDocsInner> idDocs) {
  ...
  public TransactionBulkImportRequest1DataCounterparty addIdDocsItem(ApplicantSubmitTransactionDataRequestApplicantIdDocsInner idDocsItem) {
    if (this.idDocs == null) {
  ...
  **/
   ...
   * @return the TransactionBulkImportRequest1DataCounterparty instance itself
   */
  public TransactionBulkImportRequest1DataCounterparty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionBulkImportRequest1DataCounterparty transactionBulkImportRequest1DataCounterparty = (TransactionBulkImportRequest1DataCounterparty) o;
    return Objects.equals(this.externalUserId, transactionBulkImportRequest1DataCounterparty.externalUserId) &&
        Objects.equals(this.fullName, transactionBulkImportRequest1DataCounterparty.fullName) &&
        Objects.equals(this.type, transactionBulkImportRequest1DataCounterparty.type) &&
        Objects.equals(this.address, transactionBulkImportRequest1DataCounterparty.address) &&
        Objects.equals(this.institutionInfo, transactionBulkImportRequest1DataCounterparty.institutionInfo) &&
        Objects.equals(this.paymentMethod, transactionBulkImportRequest1DataCounterparty.paymentMethod) &&
        Objects.equals(this.device, transactionBulkImportRequest1DataCounterparty.device) &&
        Objects.equals(this.idDocs, transactionBulkImportRequest1DataCounterparty.idDocs)&&
        Objects.equals(this.additionalProperties, transactionBulkImportRequest1DataCounterparty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionBulkImportRequest1DataCounterparty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionBulkImportRequest1DataCounterparty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionBulkImportRequest1DataCounterparty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionBulkImportRequest1DataCounterparty is not found in the empty JSON string", TransactionBulkImportRequest1DataCounterparty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionBulkImportRequest1DataCounterparty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionBulkImportRequest1DataCounterparty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionBulkImportRequest1DataCounterparty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionBulkImportRequest1DataCounterparty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionBulkImportRequest1DataCounterparty.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionBulkImportRequest1DataCounterparty>() {
           @Override
           public void write(JsonWriter out, TransactionBulkImportRequest1DataCounterparty value) throws IOException {
           ...
           @Override
           public TransactionBulkImportRequest1DataCounterparty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TransactionBulkImportRequest1DataCounterparty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionBulkImportRequest1DataCounterparty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionBulkImportRequest1DataCounterparty
  * @throws IOException if the JSON string is invalid with respect to TransactionBulkImportRequest1DataCounterparty
  */
  public static TransactionBulkImportRequest1DataCounterparty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionBulkImportRequest1DataCounterparty.class);
  }

 /**
  * Convert an instance of TransactionBulkImportRequest1DataCounterparty to an JSON string
  *
  * @return JSON string
  */
