...
public class TransactionBulkImportRequestDataCounterparty {
  ...
  public TransactionBulkImportRequestDataCounterparty() {
  }

  public TransactionBulkImportRequestDataCounterparty externalUserId(String externalUserId) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataCounterparty fullName(String fullName) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataCounterparty type(String type) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataCounterparty address(ApplicantSubmitTransactionDataRequestApplicantAddress address) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataCounterparty institutionInfo(ApplicantSubmitTransactionDataRequestApplicantInstitutionInfo institutionInfo) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataCounterparty paymentMethod(ApplicantSubmitTransactionDataRequestApplicantPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataCounterparty device(ApplicantSubmitTransactionDataRequestApplicantDevice device) {
  ...
  **/
  ...
  public TransactionBulkImportRequestDataCounterparty idDocs(List<ApplicantSubmitTransactionDataRequestApplicantIdDocsInner> idDocs) {
  ...
  public TransactionBulkImportRequestDataCounterparty addIdDocsItem(ApplicantSubmitTransactionDataRequestApplicantIdDocsInner idDocsItem) {
    if (this.idDocs == null) {
  ...
  **/
   ...
   * @return the TransactionBulkImportRequestDataCounterparty instance itself
   */
  public TransactionBulkImportRequestDataCounterparty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionBulkImportRequestDataCounterparty transactionBulkImportRequestDataCounterparty = (TransactionBulkImportRequestDataCounterparty) o;
    return Objects.equals(this.externalUserId, transactionBulkImportRequestDataCounterparty.externalUserId) &&
        Objects.equals(this.fullName, transactionBulkImportRequestDataCounterparty.fullName) &&
        Objects.equals(this.type, transactionBulkImportRequestDataCounterparty.type) &&
        Objects.equals(this.address, transactionBulkImportRequestDataCounterparty.address) &&
        Objects.equals(this.institutionInfo, transactionBulkImportRequestDataCounterparty.institutionInfo) &&
        Objects.equals(this.paymentMethod, transactionBulkImportRequestDataCounterparty.paymentMethod) &&
        Objects.equals(this.device, transactionBulkImportRequestDataCounterparty.device) &&
        Objects.equals(this.idDocs, transactionBulkImportRequestDataCounterparty.idDocs)&&
        Objects.equals(this.additionalProperties, transactionBulkImportRequestDataCounterparty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionBulkImportRequestDataCounterparty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionBulkImportRequestDataCounterparty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionBulkImportRequestDataCounterparty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionBulkImportRequestDataCounterparty is not found in the empty JSON string", TransactionBulkImportRequestDataCounterparty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionBulkImportRequestDataCounterparty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionBulkImportRequestDataCounterparty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionBulkImportRequestDataCounterparty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionBulkImportRequestDataCounterparty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionBulkImportRequestDataCounterparty.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionBulkImportRequestDataCounterparty>() {
           @Override
           public void write(JsonWriter out, TransactionBulkImportRequestDataCounterparty value) throws IOException {
           ...
           @Override
           public TransactionBulkImportRequestDataCounterparty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TransactionBulkImportRequestDataCounterparty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionBulkImportRequestDataCounterparty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionBulkImportRequestDataCounterparty
  * @throws IOException if the JSON string is invalid with respect to TransactionBulkImportRequestDataCounterparty
  */
  public static TransactionBulkImportRequestDataCounterparty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionBulkImportRequestDataCounterparty.class);
  }

 /**
  * Convert an instance of TransactionBulkImportRequestDataCounterparty to an JSON string
  *
  * @return JSON string
  */
