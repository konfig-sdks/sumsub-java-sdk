 ...
 */
@ApiModel(description = "Transaction participant data with mandatory `applicantId` (sender or remitter, depending on `info.direction`).")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ApplicantSubmitTransactionForNonExistingRequest1Applicant {
  ...
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant() {
  }

  public ApplicantSubmitTransactionForNonExistingRequest1Applicant externalUserId(String externalUserId) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant fullName(String fullName) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant type(String type) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant address(ApplicantSubmitTransactionDataRequestApplicantAddress address) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant institutionInfo(ApplicantSubmitTransactionDataRequestApplicantInstitutionInfo institutionInfo) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant paymentMethod(ApplicantSubmitTransactionDataRequestApplicantPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant device(ApplicantSubmitTransactionDataRequestApplicantDevice device) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant idDocs(List<ApplicantSubmitTransactionDataRequestApplicantIdDocsInner> idDocs) {
  ...
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant addIdDocsItem(ApplicantSubmitTransactionDataRequestApplicantIdDocsInner idDocsItem) {
    if (this.idDocs == null) {
  ...
  **/
   ...
   * @return the ApplicantSubmitTransactionForNonExistingRequest1Applicant instance itself
   */
  public ApplicantSubmitTransactionForNonExistingRequest1Applicant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicantSubmitTransactionForNonExistingRequest1Applicant applicantSubmitTransactionForNonExistingRequest1Applicant = (ApplicantSubmitTransactionForNonExistingRequest1Applicant) o;
    return Objects.equals(this.externalUserId, applicantSubmitTransactionForNonExistingRequest1Applicant.externalUserId) &&
        Objects.equals(this.fullName, applicantSubmitTransactionForNonExistingRequest1Applicant.fullName) &&
        Objects.equals(this.type, applicantSubmitTransactionForNonExistingRequest1Applicant.type) &&
        Objects.equals(this.address, applicantSubmitTransactionForNonExistingRequest1Applicant.address) &&
        Objects.equals(this.institutionInfo, applicantSubmitTransactionForNonExistingRequest1Applicant.institutionInfo) &&
        Objects.equals(this.paymentMethod, applicantSubmitTransactionForNonExistingRequest1Applicant.paymentMethod) &&
        Objects.equals(this.device, applicantSubmitTransactionForNonExistingRequest1Applicant.device) &&
        Objects.equals(this.idDocs, applicantSubmitTransactionForNonExistingRequest1Applicant.idDocs)&&
        Objects.equals(this.additionalProperties, applicantSubmitTransactionForNonExistingRequest1Applicant.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicantSubmitTransactionForNonExistingRequest1Applicant {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplicantSubmitTransactionForNonExistingRequest1Applicant
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicantSubmitTransactionForNonExistingRequest1Applicant.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicantSubmitTransactionForNonExistingRequest1Applicant is not found in the empty JSON string", ApplicantSubmitTransactionForNonExistingRequest1Applicant.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicantSubmitTransactionForNonExistingRequest1Applicant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicantSubmitTransactionForNonExistingRequest1Applicant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicantSubmitTransactionForNonExistingRequest1Applicant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicantSubmitTransactionForNonExistingRequest1Applicant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicantSubmitTransactionForNonExistingRequest1Applicant.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicantSubmitTransactionForNonExistingRequest1Applicant>() {
           @Override
           public void write(JsonWriter out, ApplicantSubmitTransactionForNonExistingRequest1Applicant value) throws IOException {
           ...
           @Override
           public ApplicantSubmitTransactionForNonExistingRequest1Applicant read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApplicantSubmitTransactionForNonExistingRequest1Applicant instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApplicantSubmitTransactionForNonExistingRequest1Applicant given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApplicantSubmitTransactionForNonExistingRequest1Applicant
  * @throws IOException if the JSON string is invalid with respect to ApplicantSubmitTransactionForNonExistingRequest1Applicant
  */
  public static ApplicantSubmitTransactionForNonExistingRequest1Applicant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicantSubmitTransactionForNonExistingRequest1Applicant.class);
  }

 /**
  * Convert an instance of ApplicantSubmitTransactionForNonExistingRequest1Applicant to an JSON string
  *
  * @return JSON string
  */
