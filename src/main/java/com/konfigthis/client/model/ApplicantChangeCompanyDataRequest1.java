...
public class ApplicantChangeCompanyDataRequest1 {
  ...
  public ApplicantChangeCompanyDataRequest1() {
  }

  public ApplicantChangeCompanyDataRequest1 companyName(String companyName) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 registrationNumber(String registrationNumber) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 country(String country) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 legalAddress(String legalAddress) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 incorporatedOn(String incorporatedOn) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 type(String type) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 email(String email) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 controlScheme(String controlScheme) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 phone(String phone) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 taxId(String taxId) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 registrationLocation(String registrationLocation) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 website(String website) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 postalAddress(String postalAddress) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 beneficiaries(List<String> beneficiaries) {
  ...
  public ApplicantChangeCompanyDataRequest1 addBeneficiariesItem(String beneficiariesItem) {
  ...
  **/
  ...
  public ApplicantChangeCompanyDataRequest1 addresses(List<String> addresses) {
  ...
  public ApplicantChangeCompanyDataRequest1 addAddressesItem(String addressesItem) {
  ...
  **/
   ...
   * @return the ApplicantChangeCompanyDataRequest1 instance itself
   */
  public ApplicantChangeCompanyDataRequest1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicantChangeCompanyDataRequest1 applicantChangeCompanyDataRequest1 = (ApplicantChangeCompanyDataRequest1) o;
    return Objects.equals(this.companyName, applicantChangeCompanyDataRequest1.companyName) &&
        Objects.equals(this.registrationNumber, applicantChangeCompanyDataRequest1.registrationNumber) &&
        Objects.equals(this.country, applicantChangeCompanyDataRequest1.country) &&
        Objects.equals(this.legalAddress, applicantChangeCompanyDataRequest1.legalAddress) &&
        Objects.equals(this.incorporatedOn, applicantChangeCompanyDataRequest1.incorporatedOn) &&
        Objects.equals(this.type, applicantChangeCompanyDataRequest1.type) &&
        Objects.equals(this.email, applicantChangeCompanyDataRequest1.email) &&
        Objects.equals(this.controlScheme, applicantChangeCompanyDataRequest1.controlScheme) &&
        Objects.equals(this.phone, applicantChangeCompanyDataRequest1.phone) &&
        Objects.equals(this.taxId, applicantChangeCompanyDataRequest1.taxId) &&
        Objects.equals(this.registrationLocation, applicantChangeCompanyDataRequest1.registrationLocation) &&
        Objects.equals(this.website, applicantChangeCompanyDataRequest1.website) &&
        Objects.equals(this.postalAddress, applicantChangeCompanyDataRequest1.postalAddress) &&
        Objects.equals(this.beneficiaries, applicantChangeCompanyDataRequest1.beneficiaries) &&
        Objects.equals(this.addresses, applicantChangeCompanyDataRequest1.addresses)&&
        Objects.equals(this.additionalProperties, applicantChangeCompanyDataRequest1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicantChangeCompanyDataRequest1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplicantChangeCompanyDataRequest1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicantChangeCompanyDataRequest1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicantChangeCompanyDataRequest1 is not found in the empty JSON string", ApplicantChangeCompanyDataRequest1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicantChangeCompanyDataRequest1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicantChangeCompanyDataRequest1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicantChangeCompanyDataRequest1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicantChangeCompanyDataRequest1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicantChangeCompanyDataRequest1.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicantChangeCompanyDataRequest1>() {
           @Override
           public void write(JsonWriter out, ApplicantChangeCompanyDataRequest1 value) throws IOException {
           ...
           @Override
           public ApplicantChangeCompanyDataRequest1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApplicantChangeCompanyDataRequest1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApplicantChangeCompanyDataRequest1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApplicantChangeCompanyDataRequest1
  * @throws IOException if the JSON string is invalid with respect to ApplicantChangeCompanyDataRequest1
  */
  public static ApplicantChangeCompanyDataRequest1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicantChangeCompanyDataRequest1.class);
  }

 /**
  * Convert an instance of ApplicantChangeCompanyDataRequest1 to an JSON string
  *
  * @return JSON string
  */
