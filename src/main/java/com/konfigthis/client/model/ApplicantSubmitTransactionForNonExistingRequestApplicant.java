...
public class ApplicantSubmitTransactionForNonExistingRequestApplicant {
  ...
  public ApplicantSubmitTransactionForNonExistingRequestApplicant() {
  }

  public ApplicantSubmitTransactionForNonExistingRequestApplicant externalUserId(String externalUserId) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequestApplicant fullName(String fullName) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequestApplicant type(String type) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequestApplicant address(ApplicantSubmitTransactionDataRequestApplicantAddress address) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequestApplicant institutionInfo(ApplicantSubmitTransactionDataRequestApplicantInstitutionInfo institutionInfo) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequestApplicant paymentMethod(ApplicantSubmitTransactionDataRequestApplicantPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequestApplicant device(ApplicantSubmitTransactionDataRequestApplicantDevice device) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionForNonExistingRequestApplicant idDocs(List<ApplicantSubmitTransactionDataRequestApplicantIdDocsInner> idDocs) {
  ...
  public ApplicantSubmitTransactionForNonExistingRequestApplicant addIdDocsItem(ApplicantSubmitTransactionDataRequestApplicantIdDocsInner idDocsItem) {
    if (this.idDocs == null) {
  ...
  **/
   ...
   * @return the ApplicantSubmitTransactionForNonExistingRequestApplicant instance itself
   */
  public ApplicantSubmitTransactionForNonExistingRequestApplicant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicantSubmitTransactionForNonExistingRequestApplicant applicantSubmitTransactionForNonExistingRequestApplicant = (ApplicantSubmitTransactionForNonExistingRequestApplicant) o;
    return Objects.equals(this.externalUserId, applicantSubmitTransactionForNonExistingRequestApplicant.externalUserId) &&
        Objects.equals(this.fullName, applicantSubmitTransactionForNonExistingRequestApplicant.fullName) &&
        Objects.equals(this.type, applicantSubmitTransactionForNonExistingRequestApplicant.type) &&
        Objects.equals(this.address, applicantSubmitTransactionForNonExistingRequestApplicant.address) &&
        Objects.equals(this.institutionInfo, applicantSubmitTransactionForNonExistingRequestApplicant.institutionInfo) &&
        Objects.equals(this.paymentMethod, applicantSubmitTransactionForNonExistingRequestApplicant.paymentMethod) &&
        Objects.equals(this.device, applicantSubmitTransactionForNonExistingRequestApplicant.device) &&
        Objects.equals(this.idDocs, applicantSubmitTransactionForNonExistingRequestApplicant.idDocs)&&
        Objects.equals(this.additionalProperties, applicantSubmitTransactionForNonExistingRequestApplicant.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicantSubmitTransactionForNonExistingRequestApplicant {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplicantSubmitTransactionForNonExistingRequestApplicant
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicantSubmitTransactionForNonExistingRequestApplicant.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicantSubmitTransactionForNonExistingRequestApplicant is not found in the empty JSON string", ApplicantSubmitTransactionForNonExistingRequestApplicant.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicantSubmitTransactionForNonExistingRequestApplicant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicantSubmitTransactionForNonExistingRequestApplicant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicantSubmitTransactionForNonExistingRequestApplicant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicantSubmitTransactionForNonExistingRequestApplicant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicantSubmitTransactionForNonExistingRequestApplicant.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicantSubmitTransactionForNonExistingRequestApplicant>() {
           @Override
           public void write(JsonWriter out, ApplicantSubmitTransactionForNonExistingRequestApplicant value) throws IOException {
           ...
           @Override
           public ApplicantSubmitTransactionForNonExistingRequestApplicant read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApplicantSubmitTransactionForNonExistingRequestApplicant instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApplicantSubmitTransactionForNonExistingRequestApplicant given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApplicantSubmitTransactionForNonExistingRequestApplicant
  * @throws IOException if the JSON string is invalid with respect to ApplicantSubmitTransactionForNonExistingRequestApplicant
  */
  public static ApplicantSubmitTransactionForNonExistingRequestApplicant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicantSubmitTransactionForNonExistingRequestApplicant.class);
  }

 /**
  * Convert an instance of ApplicantSubmitTransactionForNonExistingRequestApplicant to an JSON string
  *
  * @return JSON string
  */
