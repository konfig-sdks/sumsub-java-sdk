...
public class ApplicantSubmitTransactionDataRequest1Counterparty {
  ...
  public ApplicantSubmitTransactionDataRequest1Counterparty() {
  }

  public ApplicantSubmitTransactionDataRequest1Counterparty externalUserId(String externalUserId) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Counterparty fullName(String fullName) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Counterparty type(String type) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Counterparty address(ApplicantSubmitTransactionDataRequestApplicantAddress address) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Counterparty institutionInfo(ApplicantSubmitTransactionDataRequestApplicantInstitutionInfo institutionInfo) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Counterparty paymentMethod(ApplicantSubmitTransactionDataRequestApplicantPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Counterparty device(ApplicantSubmitTransactionDataRequestApplicantDevice device) {
  ...
  **/
  ...
  public ApplicantSubmitTransactionDataRequest1Counterparty idDocs(List<ApplicantSubmitTransactionDataRequestApplicantIdDocsInner> idDocs) {
  ...
  public ApplicantSubmitTransactionDataRequest1Counterparty addIdDocsItem(ApplicantSubmitTransactionDataRequestApplicantIdDocsInner idDocsItem) {
    if (this.idDocs == null) {
  ...
  **/
   ...
   * @return the ApplicantSubmitTransactionDataRequest1Counterparty instance itself
   */
  public ApplicantSubmitTransactionDataRequest1Counterparty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicantSubmitTransactionDataRequest1Counterparty applicantSubmitTransactionDataRequest1Counterparty = (ApplicantSubmitTransactionDataRequest1Counterparty) o;
    return Objects.equals(this.externalUserId, applicantSubmitTransactionDataRequest1Counterparty.externalUserId) &&
        Objects.equals(this.fullName, applicantSubmitTransactionDataRequest1Counterparty.fullName) &&
        Objects.equals(this.type, applicantSubmitTransactionDataRequest1Counterparty.type) &&
        Objects.equals(this.address, applicantSubmitTransactionDataRequest1Counterparty.address) &&
        Objects.equals(this.institutionInfo, applicantSubmitTransactionDataRequest1Counterparty.institutionInfo) &&
        Objects.equals(this.paymentMethod, applicantSubmitTransactionDataRequest1Counterparty.paymentMethod) &&
        Objects.equals(this.device, applicantSubmitTransactionDataRequest1Counterparty.device) &&
        Objects.equals(this.idDocs, applicantSubmitTransactionDataRequest1Counterparty.idDocs)&&
        Objects.equals(this.additionalProperties, applicantSubmitTransactionDataRequest1Counterparty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicantSubmitTransactionDataRequest1Counterparty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplicantSubmitTransactionDataRequest1Counterparty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicantSubmitTransactionDataRequest1Counterparty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicantSubmitTransactionDataRequest1Counterparty is not found in the empty JSON string", ApplicantSubmitTransactionDataRequest1Counterparty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicantSubmitTransactionDataRequest1Counterparty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicantSubmitTransactionDataRequest1Counterparty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicantSubmitTransactionDataRequest1Counterparty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicantSubmitTransactionDataRequest1Counterparty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicantSubmitTransactionDataRequest1Counterparty.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicantSubmitTransactionDataRequest1Counterparty>() {
           @Override
           public void write(JsonWriter out, ApplicantSubmitTransactionDataRequest1Counterparty value) throws IOException {
           ...
           @Override
           public ApplicantSubmitTransactionDataRequest1Counterparty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApplicantSubmitTransactionDataRequest1Counterparty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApplicantSubmitTransactionDataRequest1Counterparty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApplicantSubmitTransactionDataRequest1Counterparty
  * @throws IOException if the JSON string is invalid with respect to ApplicantSubmitTransactionDataRequest1Counterparty
  */
  public static ApplicantSubmitTransactionDataRequest1Counterparty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicantSubmitTransactionDataRequest1Counterparty.class);
  }

 /**
  * Convert an instance of ApplicantSubmitTransactionDataRequest1Counterparty to an JSON string
  *
  * @return JSON string
  */
