...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.sumsub.com";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("sec0", new ApiKeyAuth("header", "X-App-Token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sumsub.com)
